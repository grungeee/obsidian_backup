...
Wie werden Eisen-Gusswerkstoffe eingeteilt?:: 
- Stahlguss,
- Temperguss,
- Gusseisen,
- Sondergussarten

Wie werden Nichteisenmetalle eingeteilt und nenne je zwei?:: 
Leichtmetalle:
- Dichte < 5 kg/dm³ [ Aluminium, Magnesium, Titan ]
Schwermetalle:
- Dichte > 5 kg/dm³ [ Kupfer, Zink, Blei , Chrom, Nickel ]

Benennen u. beschreiben Sie 2 Nichteisenmetalle aus dem Prüfungskoffer!:: 
- Kupferblech,
- Messingblech,
- Aluminiumblech,
...
Nennen Sie drei typische Anwendungen von Eisen-Gusswerkstoffen::
- Maschinengestelle,
- Pumpen,
- Lenkhebel,
- Fittings,
...
Nennen und übersetzen Sie die Werkstoffbezeichnungen GE 200, G20Mo5!:: 
GE 200:
...
Nennen Sie drei Eigenschaften von Stahlguss!:: 
- Hohe Festigkeit,
- Härtbarkeit der Oberfläche
- zäh,
- vergütbar,

Nennen Sie drei Beispiele der Verwendung von StahlGuss (GE oder GS)! :: 
- Kranhaken,
- Turbinenteile,
- Pressenständer,
...
Nennen Sie eine Stahlbezeichnung für den Stahlbau!:: 
- S355J2G1,
- S275JRG2,

Nennen Sie 2 Verwendungsbeispiele für Allgemeinen Baustahl!:: 
- Stahlbau,
- Schiffsbau,
- Fahrzeugbau

Nennen Sie je eine Stahlbezeichnung für Einsatz-, Vergütungs-, und Werkzeugstahl und erläutern Sie diese!::
...
Nennen Sie 2 Gründe, weshalb Stähle legiert werden!::
Verbesserte :
 - Härtbarkeit,
 - Warmfestigkeit,
 - Schneidfähigkeit

Nennen Sie die Grenze zwischen niedrig- und hochlegiertem Stahl!::
Bei 5% Legierungsbestandteilen

Übersetzen Sie die Stahlbezeichnung C10E:: C10E
C -> Unlegierter Stahl
10 -> mit 0,1% Kohlenstoff, daher Einsatzstahl
E -> für vorgeschriebenen max. Schwefelgehalt

Wie beeinflusst der Kohlenstoffgehalt und der Schwefel den Stahl?:: 
Kohlenstoff:
- hoch: 
...
Übersetzen Sie die Stahlbezei chnung 10CrMo9-10::
...
Übersetzen Sie die Stahlbez1Ni18-10::
...
Erklären Sie den Begriff „Zähigkeit" anhand eines Beispiels!::
...
Aus welchem Grund sind Automatenstähle nicht schweißgeeignet?::
