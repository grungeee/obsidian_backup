...
- Abtrag: Zuerst werden die Körnchen abgerieben, dann das Bindemittel
- Körnung
...
## Absperrventil 
- 3 englische (Zollgewinde, Withworth-Gewinde)
- 1 Bewegungsgewinde - Rund 
- 2 Vierdichtringe 
- Ist ein Messingguss 
	- Indikator: Farbe und Trennlinie vom Gießen
...
- Formlehre
### Grenzlehren 
- Hauptsächlich fuer Massenfaertigung
- Gut-Seite -> Anschnäbelt, aber noch nicht durchlässt -> gut
- Ausschusseite -> Anschnäbelt -> schlecht


## Messwerkzeuge
### Bügelmessschraube
![[Pasted image 20230615220247.png]]
Statt Ratsche wird Gefühlsratsche gesagt. 
Schwarzes teil ist die Isolierung. 
### Radialwellendichtring
Wird zum Beispiel in der Bügelmessschraube zum Feststellen verwendet. 
