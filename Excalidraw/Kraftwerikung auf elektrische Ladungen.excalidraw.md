...
Gleichnamige Ladungen stoßen einander ab ^4UNpclKt
...
```json
{
	...
	"elements": [
		...
		},
		{
			...
			"opacity": 100,
			"angle": 0,
			"x": 441.46783618311497,
			"y": -348.141231547864,
			"strokeColor": "#5f3dc4",
			"backgroundColor": "transparent",
			"width": 577.499755859375,
			"height": 35,
			"seed": 1161224598,
			"groupIds": [],
			"roundness": null,
			...
			"fontSize": 28,
			"fontFamily": 1,
			"text": "Gleichnamige Ladungen stoßen einander ab",
			"rawText": "Gleichnamige Ladungen stoßen einander ab",
			"textAlign": "left",
			"verticalAlign": "top",
			"containerId": null,
